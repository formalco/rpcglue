...
func templatesClientGohtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/client.gohtml", size: 705, mode: os.FileMode(420), modTime: time.Unix(1757391100, 0)}
